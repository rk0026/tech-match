    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <Link href="/" className="inline-flex items-center text-slate-500 hover:text-white transition-colors mb-8 group">
                ...
                <div className="glass-card rounded-3xl p-8 shadow-2xl border border-white/5">
                    <div className="mb-10 text-center">
                        ...
                        <p className="text-slate-400 text-sm">Authenticate your session to continue.</p>
                    </div>
                ...
                <div className="mt-8 text-center text-[10px] text-slate-600 uppercase tracking-[0.2em]">
                    Secured by TechMatch Core Infrastructure
                </div>
            </div>
        </div>
    );
